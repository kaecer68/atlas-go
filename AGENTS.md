...
This project is indexed by GitNexus as **atlas-go** (35335 symbols, 81099 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
