...
This project is indexed by GitNexus as **atlas-go** (37744 symbols, 87109 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
