...
This project is indexed by GitNexus as **atlas-go** (37716 symbols, 86900 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
