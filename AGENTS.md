...
This project is indexed by GitNexus as **atlas-go** (41868 symbols, 128528 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
