...
This project is indexed by GitNexus as **atlas** (10206 symbols, 26840 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
