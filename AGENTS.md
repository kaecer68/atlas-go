...
This project is indexed by GitNexus as **atlas-go** (37704 symbols, 86897 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
