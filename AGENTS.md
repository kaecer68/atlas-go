...
This project is indexed by GitNexus as **atlas-go** (41301 symbols, 125890 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
