...
This project is indexed by GitNexus as **atlas-go** (41298 symbols, 125876 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
