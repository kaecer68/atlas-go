...
This project is indexed by GitNexus as **atlas-go** (48274 symbols, 147476 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
