...
This project is indexed by GitNexus as **atlas-go** (34931 symbols, 80128 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
