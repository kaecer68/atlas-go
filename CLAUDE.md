...
This project is indexed by GitNexus as **atlas-go** (21676 symbols, 47380 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
