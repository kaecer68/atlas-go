...
This project is indexed by GitNexus as **atlas-go** (22185 symbols, 48846 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
