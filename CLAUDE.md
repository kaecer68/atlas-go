...
This project is indexed by GitNexus as **atlas-go** (32203 symbols, 74083 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
