...
| 部署設定 | **production 在 Mac Mini**（`ssh kmacmini`）：`~/workspace/a2a-dev/docs/deployment/MACMINI-DEPLOY-RUNBOOK.md`；本機 Docker 開發：`docs/operations/local-deploy.md` |
