...
This project is indexed by GitNexus as **atlas-go** (22441 symbols, 49334 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
