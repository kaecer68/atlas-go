...
This project is indexed by GitNexus as **atlas-go** (22815 symbols, 50291 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
