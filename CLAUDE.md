...
This project is indexed by GitNexus as **atlas-go** (26843 symbols, 59022 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
