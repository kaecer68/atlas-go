...
This project is indexed by GitNexus as **atlas-go** (24214 symbols, 53239 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
