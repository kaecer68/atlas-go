...
**相關文檔**: `docs/developer_guide.md`（Go 代碼命名） · `docs/DATA_ARCHITECTURE.md`（資料架構） · `docs/audit/P0.2_root_cause_analysis.md`（根因分析）
...
*參考: docs/audit/P0.2_root_cause_analysis.md FG-1, FG-2*
