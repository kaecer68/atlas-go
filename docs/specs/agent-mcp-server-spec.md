...
> - [`agent-loop-state-machine.md`](./agent-loop-state-machine-spec.md)（AgentLoop 細節）
...
> **Prism（移除，2026-08-12）**：`prism_get_training_results` 已刪除（PRISM 未啟用，決策 #1527）。tool 清單不含 prism 屬預期。
