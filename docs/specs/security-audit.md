...
- [ ] 市場資料缺失時 fail-safe 行為已實作(`docs/TRAPS.md` 的 live trading 安全旗標陷阱)。
...
- [ ] `ParametersConfig` 為唯一參數管理入口,無 hardcoded magic number(參考 `docs/PARAMETER_SYSTEM.md`)。
...
- [ ] `docs/TRAPS.md` 包含 live trading 安全旗標陷阱與 apigateway 憲法違反陷阱。
