...
Operational procedures (pre-flight / daily check-in / acceptance / rollback) live in ../operations/l2-4-runbook.md.) Future work (auto-cron / promotion) tracked in .omo/manifests/l2-4-followup.md.)
...
- L2.4 follow-up: [`./l2-4-observation-spec.md`](./l2-4-observation-spec.md) (metrics spec), [`../operations/l2-4-runbook.md`](../operations/l2-4-runbook.md) (ops manual), `.omo/manifests/l2-4-followup.md` (future work)
