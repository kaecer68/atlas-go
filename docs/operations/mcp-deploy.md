...
- 計劃藍圖： [`.omo/notepads/agent-interface-roadmap.md`](../../.omo/notepads/agent-interface-roadmap.md)（原 `docs/plans/agent-interface-roadmap.md`,2026-07-03 移至 `.omo/notepads/` 作為 spec snapshot,canonical spec 見 `docs/specs/agent-mcp-server.md`）
