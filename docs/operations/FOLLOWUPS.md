...
### FU-20260926-08 — FinMind 402 latch 的三個殘留面（跨行程可見性／上游真實上限未知／探針語意）

- **狀態**：`open`
- **記錄日期**：2026-09-26
- **編號說明**：本條原以 `FU-20260926-01` 建檔（PR #2006），與同日另一 lane 併入 main 的
  [#2005](https://github.com/kaecer68/atlas-go/pull/2005) 之 `FU-20260926-01..07` **編號撞號**，
  追平 main 時（merge `origin/main` → `788045dd`）改為 `-08`。
