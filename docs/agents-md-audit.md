...
> 操作程序 / playbook → `docs/`
> 憲法級強制規範 → `docs/CONSTITUTION.md`、`internal/apigateway/CONSTITUTION.md`
...
| 7 | config | 38 | **B** | `docs/PARAMETER_SYSTEM.md` 涵蓋 .env / Magic number |
...
| **併入 root AGENTS.md** | screener | 永不回傳錯誤契約已在 `docs/TRAPS.md` 提及 |
...
| screener | 內容已於 `docs/TRAPS.md` 提及 |
