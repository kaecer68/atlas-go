...
>
> 涵蓋 ~25 個高頻率查詢（從 108 tool 中篩選，投資人每天都會用到的）。其他 83+ tool 見 [`REFERENCE/tool-catalog.md`](../REFERENCE/tool-catalog.md)。
>
...
**顯示範例**：`✓ atlas-mcp ok | 108 tools registered | uptime 4h 23m`
...
不確定的話：
- 108 tool 完整 catalog 見 [`REFERENCE/tool-catalog.md`](../REFERENCE/tool-catalog.md)
