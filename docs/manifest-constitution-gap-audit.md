...
| # | 項目 | 狀態 | 備註 / PR |
|---|------|------|-----------|
| F1 | 外資雙重動機模型 | ✅ | #1394 — T86 column 4(結構性) vs 7(投機性) |
| F2 | 自營商大小分流 | ✅ | #1394 — T86 column 14(自行) vs 17(避險) |
| F3 | 投信主動 vs 被動分流 | ✅ | #1395 — ETFNetSubscription + DomesticFundNet split |
| F4 | 公股分點追蹤 | ✅ | government_broker channel 已註冊 |
