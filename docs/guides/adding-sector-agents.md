...
> **Related**: [`../specs/agent-loop-state-machine.md`](../specs/agent-loop-state-machine.md) (moved from `docs/wave-11/AGENT_LOOP_STATE_MACHINE.md`), [`../specs/llm-sector-agent.md`](../specs/llm-sector-agent.md) (moved from `docs/wave-11/L2_3_PLAN_REFLECT.md`)
...
- State machine: [`../specs/agent-loop-state-machine.md`](../specs/agent-loop-state-machine.md) (moved from `docs/wave-11/AGENT_LOOP_STATE_MACHINE.md`)
- L2.3 design: [`../specs/llm-sector-agent.md`](../specs/llm-sector-agent.md) (moved from `docs/wave-11/L2_3_PLAN_REFLECT.md`)
