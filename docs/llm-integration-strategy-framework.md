...
> - §4.2-4.5 → [`docs/specs/llm-interface-contract.md`](specs/llm-interface-contract.md)（356 行）
> - §6 → [`docs/specs/llm-routing.md`](specs/llm-routing.md)（161 行）
> - §8 → [`docs/archive/llm-migration-roadmap-RESOLVED.md`](archive/llm-migration-roadmap-RESOLVED.md)（RESOLVED，164 行）
...
- **六、Provider 路由策略** → [`docs/specs/llm-routing.md`](specs/llm-routing.md)
- [七、資料流與審計軌跡（Data Flow & Audit Trail）](#七資料流與審計軌跡data-flow--audit-trail)
- **八、遷移路徑** → [`docs/archive/llm-migration-roadmap-RESOLVED.md`](archive/llm-migration-roadmap-RESOLVED.md)
...
> **📦 已抽離**：本節完整內容（含 Go 介面程式碼）移至 [`docs/specs/llm-interface-contract.md`](specs/llm-interface-contract.md) §4.2。
...
> **📦 已抽離**：本節完整內容移至 [`docs/specs/llm-routing.md`](specs/llm-routing.md)（§6 路由表、§6.1-6.5 備援策略）。
...
> **📦 已歸檔（RESOLVED）**：本節完整內容移至 [`docs/archive/llm-migration-roadmap-RESOLVED.md`](archive/llm-migration-roadmap-RESOLVED.md)。
