...
| I11 | Feature flag `SECTOR_PREDICTION_ENABLED` 預設 **false**；開啟前須通過 L2.4 observation window | config | `cmd/atlas/main.go` + `docs/reference/parameters.md` | 🟢 done | rollout safety |
