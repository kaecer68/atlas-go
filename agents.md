...
This project is indexed by GitNexus as **atlas-go** (26037 symbols, 57335 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
