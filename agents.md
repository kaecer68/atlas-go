...
This project is indexed by GitNexus as **atlas-go** (24926 symbols, 54615 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
