...
This project is indexed by GitNexus as **atlas-go** (30048 symbols, 63804 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
