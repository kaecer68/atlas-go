...
func (f *fakeOutcomeStore) RecordSessionOutcomes(domain.ReplaySession, []domain.RecommendationOutcome) error {
	return nil
}

func (f *fakeOutcomeStore) LoadOutcomes() ([]domain.RecommendationOutcome, error) { return nil, nil }

func (f *fakeOutcomeStore) LoadSessionOutcomes(string) ([]domain.RecommendationOutcome, error) {
	return nil, nil
}

func (f *fakeOutcomeStore) LoadOutcomesFromSessions() ([]domain.RecommendationOutcome, error) {
	return nil, nil
}

func (f *fakeOutcomeStore) RecordSessionScreeningRejects(string, []domain.ScreeningReject) error {
	return nil
}

func (f *fakeOutcomeStore) LoadSessionScreeningRejects(string) ([]domain.ScreeningReject, error) {
	return nil, nil
}
...
func (f *fakeOutcomeStore) RecordSessionExperiment(domain.ReplaySession, domain.ExperimentRecord) error {
	return nil
}

func (f *fakeOutcomeStore) RecordSessionSummary(domain.ReplaySession, domain.SessionSummary) error {
	return nil
}
...
func (f *fakeOutcomeStore) LoadHumanInterventions() ([]domain.HumanIntervention, error) {
	return nil, nil
}
