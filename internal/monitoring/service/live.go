...
func (s *LiveService) LoadLiveStatus() LiveStatusResponse {
	...
	if data, err := os.ReadFile(filepath.Join(s.WorkDir, live.DefaultCircuitBreakerStatePath)); err == nil {
	...
	liveBasePath := filepath.Join(s.WorkDir, live.DefaultLiveStateBasePath)
