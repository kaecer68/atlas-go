...
// lcgUint64 is a small Mulberry64-style generator used only by the test
// suite to produce deterministic pseudo-uniforms without importing math/rand.
...
func TestGumbel_IndependentUniform(t *testing.T) {
	...
	// For independent uniforms with n=1000, σ_τ ≈ 0.021, so θ ∈ [0.95, 1.10]
