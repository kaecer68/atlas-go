...
func (r *RecommendationOutcome) UnmarshalJSON(data []byte) error {
	...
	if err := json.Unmarshal(data, &legacy); err != nil {
		return fmt.Errorf("unmarshal legacy recommendation outcome: %w", err)
	}
...
func (r *ExperimentRecord) UnmarshalJSON(data []byte) error {
	...
	if err := json.Unmarshal(data, &raw); err != nil {
		return fmt.Errorf("unmarshal experiment record: %w", err)
	}
	...
	if err := json.Unmarshal(data, &legacy); err != nil {
		return fmt.Errorf("unmarshal legacy experiment record: %w", err)
	}
...
func (b *MutationBrief) UnmarshalJSON(data []byte) error {
	...
	if err := json.Unmarshal(data, &legacy); err != nil {
		return fmt.Errorf("unmarshal legacy mutation brief: %w", err)
	}
...
func (m *ReplayDataMetadata) UnmarshalJSON(data []byte) error {
	...
	if err := json.Unmarshal(data, &legacy); err != nil {
		return fmt.Errorf("unmarshal legacy replay metadata: %w", err)
	}
...
func (r *OOSResult) UnmarshalJSON(data []byte) error {
	...
	if err := json.Unmarshal(data, &legacy); err != nil {
		return fmt.Errorf("unmarshal legacy OOS result: %w", err)
	}
