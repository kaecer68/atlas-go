# AGENTS.md — internal/prism

PRISM (Parallel Regime-Specific Independent Systems for Multi-cohort training) 管理 5 個獨立 regime 訓練佇列，為 JANUS meta-layer 提供 cohort 績效數據。
