...
func TestBuildSyntheticOutcomesMarksAllAgentsPassedForSharedSymbol(t *testing.T) {
	...
	outcomes := buildSyntheticOutcomes(rawRecs, finalRecs, quotes, asOf, "risk_on")
	if len(outcomes) != 3 {
...
func TestBuildSyntheticOutcomesMarksUnpassedSymbolFailed(t *testing.T) {
	...
	outcomes := buildSyntheticOutcomes(rawRecs, finalRecs, nil, asOf, "risk_off")
	if len(outcomes) != 1 {
...
func TestBuildReplayOutcomesMarksAllAgentsPassedForSharedSymbol(t *testing.T) {
	...
	outcomes := buildReplayOutcomes(rawRecs, finalRecs, nil, asOf, "risk_on", ds)
