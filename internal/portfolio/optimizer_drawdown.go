...
//
// Extracted from optimizer.go (sub-issue-6 / P3d) to reduce optimizer.go
// size. Uses the covariance matrix from P0-1 (Ledoit-Wolf shrinkage) to
// generate correlated multi-day return paths via Monte Carlo, then computes
// drawdown statistics for stress testing.
