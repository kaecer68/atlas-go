...
func defaultIndustryParameters() IndustryParameters {
	return IndustryParameters{
		...
		"semiconductor":    0.42,
			...
			Rationale: "Taiwan market sector weights (9 canonical Level-1 IDs); source: configs/parameters.json",
			Source:    SourceEmpirical,
		...
		CycleThresholds: ParameterMetadata[map[string]CycleThresholdConfig]{
			Value: map[string]CycleThresholdConfig{
				"semiconductor": {
					ExpansionRevenuePct: 0.20, ExpansionProfitPct: 0.25,
					RecoveryRevenuePct: 0.10, RecoveryProfitPct: 0.15,
					MatureRevenuePct: 0.05, MatureProfitPct: 0.08,
				},
				"ai_supply_chain": {
					ExpansionRevenuePct: 0.25, ExpansionProfitPct: 0.30,
					RecoveryRevenuePct: 0.12, RecoveryProfitPct: 0.18,
					MatureRevenuePct: 0.05, MatureProfitPct: 0.08,
				},
				"robotics": {
					ExpansionRevenuePct: 0.15, ExpansionProfitPct: 0.18,
					RecoveryRevenuePct: 0.08, RecoveryProfitPct: 0.10,
					MatureRevenuePct: 0.03, MatureProfitPct: 0.05,
				},
				"financials": {
					ExpansionRevenuePct: 0.10, ExpansionProfitPct: 0.15,
					RecoveryRevenuePct: 0.05, RecoveryProfitPct: 0.08,
					MatureRevenuePct: 0.02, MatureProfitPct: 0.05,
				},
				"shipping": {
					ExpansionRevenuePct: 0.30, ExpansionProfitPct: 0.35,
					RecoveryRevenuePct: 0.15, RecoveryProfitPct: 0.20,
					MatureRevenuePct: 0.05, MatureProfitPct: 0.10,
				},
				"energy": {
					ExpansionRevenuePct: 0.12, ExpansionProfitPct: 0.12,
					RecoveryRevenuePct: 0.06, RecoveryProfitPct: 0.06,
					MatureRevenuePct: 0.02, MatureProfitPct: 0.02,
				},
				"electronics": {
					ExpansionRevenuePct: 0.15, ExpansionProfitPct: 0.18,
					RecoveryRevenuePct: 0.08, RecoveryProfitPct: 0.10,
				...
				"consumer": {
					ExpansionRevenuePct: 0.08, ExpansionProfitPct: 0.10,
					RecoveryRevenuePct: 0.04, RecoveryProfitPct: 0.05,
					MatureRevenuePct: 0.01, MatureProfitPct: 0.02,
				},
				"industrial": {
					ExpansionRevenuePct: 0.10, ExpansionProfitPct: 0.12,
					RecoveryRevenuePct: 0.05, RecoveryProfitPct: 0.06,
					MatureRevenuePct: 0.02, MatureProfitPct: 0.03,
				},
			},
			Rationale: "Per-industry business cycle thresholds for all 9 canonical Level-1 IDs; calibrated to sector growth characteristics",
			Source:    SourceHeuristic,
