...
func defaultSectorExecutorParameters() SectorExecutorParameters {
	return SectorExecutorParameters{
		...
		Financials: FinancialsExecutorParameters{
			DividendBoost:            ParameterMetadata[int]{Value: 8, Rationale: "Dividend boost", Source: SourceHeuristic, Todo: "Calibrate [5,8,12]"},
			BalanceSheetPenalty:      ParameterMetadata[int]{Value: 6, Rationale: "Balance-sheet penalty", Source: SourceHeuristic, Todo: "Backtest 4/6/8"},
			CreditQualityBoost:       ParameterMetadata[int]{Value: 2, Rationale: "Credit quality boost", Source: SourceHeuristic, Todo: "Validate SNR"},
			CreditQualityPenalty:     ParameterMetadata[int]{Value: 6, Rationale: "Credit quality penalty", Source: SourceHeuristic, Todo: "Calibrate 4/6/8"},
			SpreadSensitivityBoost:   ParameterMetadata[int]{Value: 2, Rationale: "Spread sensitivity boost", Source: SourceHeuristic, Todo: "Monitor precision"},
			SpreadSensitivityPenalty: ParameterMetadata[int]{Value: 4, Rationale: "Spread sensitivity penalty", Source: SourceHeuristic, Todo: "Backtest 3/4/5"},
			CapitalAdequacyBoost:     ParameterMetadata[int]{Value: 3, Rationale: "Capital adequacy boost", Source: SourceHeuristic, Todo: "Validate TW CAR"},
			PriceToOpenThreshold:     ParameterMetadata[float64]{Value: 0.985, Rationale: "Balance-sheet threshold: low < open*0.985", Source: SourceHeuristic, Todo: "Calibrate 0.980/0.985/0.990"},
			PriceToHighThreshold:     ParameterMetadata[float64]{Value: 0.995, Rationale: "Spread/capital threshold: last >= high*0.995", Source: SourceHeuristic, Todo: "Validate sensitivity"},
		},
		Shipping: ShippingExecutorParameters{
			TacticalBoost:      ParameterMetadata[int]{Value: 10, Rationale: "Tactical boost when last > open", Source: SourceHeuristic, Todo: "Calibrate vs BDI"},
			WeakClosePenalty:   ParameterMetadata[int]{Value: 12, Rationale: "Weak close penalty", Source: SourceHeuristic, Todo: "Backtest 10/12/14"},
			WeakCloseThreshold: ParameterMetadata[float64]{Value: 0.992, Rationale: "Weak close: last < high*0.992", Source: SourceHeuristic, Todo: "Calibrate 0.988/0.992/0.995"},
		},
		ValueYield: ValueYieldExecutorParameters{
			CashFlowBoost:    ParameterMetadata[int]{Value: 10, Rationale: "Cash-flow boost", Source: SourceHeuristic, Todo: "Backtest vs DPS consistency"},
			YieldTrapPenalty: ParameterMetadata[int]{Value: 10, Rationale: "Yield trap penalty", Source: SourceHeuristic, Todo: "Calibrate vs study"},
		},
		EarningsQuality: EarningsQualityExecutorParameters{
			RepeatableBoost:   ParameterMetadata[int]{Value: 9, Rationale: "Repeatable earnings boost", Source: SourceHeuristic, Todo: "Validate vs ROE persistence"},
			GuidancePenalty:   ParameterMetadata[int]{Value: 8, Rationale: "Guidance penalty", Source: SourceHeuristic, Todo: "Backtest accuracy"},
			GuidanceThreshold: ParameterMetadata[float64]{Value: 0.99, Rationale: "Guidance: last < high*0.99", Source: SourceHeuristic, Todo: "Calibrate 0.985/0.990/0.995"},
		},
		TechnicalBreakout: TechnicalBreakoutExecutorParameters{
			DefaultVolumeFloor:     ParameterMetadata[int64]{Value: 5000000, Rationale: "Default volume floor 5M", Source: SourceHeuristic, Todo: "Calibrate 3M/5M/7M"},
			StrictVolumeFloor:      ParameterMetadata[int64]{Value: 7000000, Rationale: "Strict surge floor 7M", Source: SourceHeuristic, Todo: "Validate vs hit rates"},
			RelaxedVolumeFloor:     ParameterMetadata[int64]{Value: 0, Rationale: "Relaxed floor for expansion", Source: SourceHeuristic, Todo: "Monitor quality"},
			LowVolumeFloor:         ParameterMetadata[int64]{Value: 3000000, Rationale: "Low vol floor 3M", Source: SourceHeuristic, Todo: "Compare hit rates"},
			LowVolumeBoost:         ParameterMetadata[int]{Value: 3, Rationale: "Low vol boost", Source: SourceHeuristic, Todo: "Validate precision"},
			RejectLowVolumeFloor:   ParameterMetadata[int64]{Value: 5000000, Rationale: "Reject low vol floor", Source: SourceHeuristic, Todo: "Calibrate false breakout"},
			VolumeBoost:            ParameterMetadata[int]{Value: 8, Rationale: "Volume confirmation boost", Source: SourceHeuristic, Todo: "Calibrate 6/8/10"},
			CloseStrengthPenalty:   ParameterMetadata[int]{Value: 1, Rationale: "Close strength penalty", Source: SourceHeuristic, Todo: "Validate magnitude"},
			CloseStrengthThreshold: ParameterMetadata[float64]{Value: 0.985, Rationale: "Close strength trigger: last < high*0.985", Source: SourceHeuristic, Todo: "Calibrate 0.980/0.985/0.990"},
			CloseStrengthTolerance: ParameterMetadata[float64]{Value: 0.98, Rationale: "Close strength tolerance", Source: SourceHeuristic, Todo: "Calibrate band"},
			SurgeBoost:             ParameterMetadata[int]{Value: 4, Rationale: "Surge boost", Source: SourceHeuristic, Todo: "Backtest 3/4/5"},
			SurgePenalty:           ParameterMetadata[int]{Value: 4, Rationale: "Surge penalty", Source: SourceHeuristic, Todo: "Calibrate false-surge"},
			OpenRejectionPenalty:   ParameterMetadata[int]{Value: 10, Rationale: "Open rejection penalty", Source: SourceHeuristic, Todo: "Validate false-breakout rate"},
			LateBreakoutPenalty:    ParameterMetadata[int]{Value: 8, Rationale: "Late-breakout penalty", Source: SourceHeuristic, Todo: "Calibrate 6/8/10"},
			LateBreakoutThreshold:  ParameterMetadata[float64]{Value: 0.998, Rationale: "Late breakout: last < high*0.998", Source: SourceHeuristic, Todo: "Calibrate 0.995/0.998/0.999"},
			ConfirmationBoost:      ParameterMetadata[int]{Value: 12, Rationale: "Confirmation bonus", Source: SourceHeuristic, Todo: "Backtest 10/12/14"},
			ConfirmationThreshold:  ParameterMetadata[float64]{Value: 0.998, Rationale: "Confirmation: last >= high*0.998", Source: SourceHeuristic, Todo: "Calibrate quality"},
			CatchUpBoost:           ParameterMetadata[int]{Value: 6, Rationale: "Catch-up boost", Source: SourceHeuristic, Todo: "Backtest 4/6/8"},
			CatchUpLowerThreshold:  ParameterMetadata[float64]{Value: 0.993, Rationale: "Catch-up lower bound", Source: SourceHeuristic, Todo: "Calibrate zone"},
			CatchUpUpperThreshold:  ParameterMetadata[float64]{Value: 0.998, Rationale: "Catch-up upper bound", Source: SourceHeuristic, Todo: "Calibrate zone"},
		},
		GrowthMomentum: GrowthMomentumExecutorParameters{
			ConvictionBase:           ParameterMetadata[int]{Value: 45, Rationale: "Base conviction", Source: SourceHeuristic, Todo: "Calibrate 40/45/50"},
			PricePenalty:             ParameterMetadata[int]{Value: 8, Rationale: "Price penalty when last < open", Source: SourceHeuristic, Todo: "Calibrate 6/8/10"},
			TrendConfirmationPenalty: ParameterMetadata[int]{Value: 15, Rationale: "Trend confirmation penalty", Source: SourceHeuristic, Todo: "Backtest 12/15/18"},
			DowngradePricePenalty:    ParameterMetadata[int]{Value: 12, Rationale: "Downgrade price penalty", Source: SourceHeuristic, Todo: "Calibrate 10/12/14"},
			DowngradeOpenPenalty:     ParameterMetadata[int]{Value: 8, Rationale: "Downgrade open penalty", Source: SourceHeuristic, Todo: "Backtest 6/8/10"},
			ExploratoryPricePenalty:  ParameterMetadata[int]{Value: 6, Rationale: "Exploratory price penalty (reduced)", Source: SourceHeuristic, Todo: "Monitor vs standard"},
