...
var canaryRoutes = map[string]canaryTest{
	...
	"stock_get_condition_winrate":       {Path: "/api/stock/condition_winrate?condition_id=momentum-20d-positive", Keys: []string{"found", "condition_id", "direction"}},
	"stock_get_industry_winrate":        {Path: "/api/stock/industry_winrate?condition_id=momentum-20d-positive", Keys: []string{"found", "condition_id", "direction", "coverage"}},
