...
var canaryRoutes = map[string]canaryTest{
	...
	"macro_get_snapshot_history":        {Path: "/api/macro/snapshot/history?date=2026-07-22"},
	...
	"macro_get_ingest_status":           {Path: "/api/macro/snapshot/timeline"},
	...
	"universe_get_session_detail":       {Path: "/api/dashboard/sessions/{id}"},
