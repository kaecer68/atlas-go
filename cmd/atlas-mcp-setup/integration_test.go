...
//  5. Verify the response includes the expected tool count (89-91)
//
...
//   - tools/list responds with the expected number of tools (89-91)
...
func TestAtlasMCP_EndToEnd(t *testing.T) {
	...
	got := len(tools)
	if got < 89 || got > 91 {
		t.Errorf("expected 89-91 tools, got %d", got)
	}
